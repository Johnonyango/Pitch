...
Revision ID: b5d78d2c1f97
Revises: 0b402dd3d7a4
Create Date: 2019-08-05 11:48:56.949130
...
revision = 'b5d78d2c1f97'
down_revision = '0b402dd3d7a4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('username', sa.String(length=41), nullable=True),
